...
Three annotation conditions x 5 panel sequences x n=40, framed as a
...
3 conditions x 5 sequences x n=40 = **600 calls per model**. Start on
...
Per cell (protein x condition): counts of each outcome.
Per model: a **confusion matrix** of {ground-truth MATCH/MISMATCH} x
